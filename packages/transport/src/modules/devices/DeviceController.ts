...
import { CoreBuffer, CryptoSecretKeyHandle, CryptoSignature, CryptoSignaturePrivateKey, CryptoSignaturePublicKey } from "@nmshd/crypto";
...
export class DeviceController extends TransportController {
    ...
    @log()
    public override async init(baseKey: CryptoSecretKeyHandle, device: Device): Promise<DeviceController> {
        await super.init();
