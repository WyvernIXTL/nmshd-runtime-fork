...
describe("RelationshipTemplateController", function () {
    ...
    test("should send and receive a RelationshipTemplate", async function () {
        ...
        const templateReference = (await sentRelationshipTemplate.toRelationshipTemplateReference()).truncate();
    ...
    test("should create templates with maxNumberOfAllocations=undefined", async function () {
        ...
        const templateReference = (await ownTemplate.toRelationshipTemplateReference()).truncate();
    ...
    test("should create and load a personalized template", async function () {
        ...
        const peerTemplate = await recipient.relationshipTemplates.loadPeerRelationshipTemplateByTruncated((await ownTemplate.toRelationshipTemplateReference()).truncate());
        expect(peerTemplate).toBeDefined();
    });
    ...
    test("should throw an error if loaded by the wrong identity", async function () {
        ...
        await expect(recipient.relationshipTemplates.loadPeerRelationshipTemplateByTruncated((await ownTemplate.toRelationshipTemplateReference()).truncate())).rejects.toThrow(
    ...
    test("should create and load a password-protected template", async function () {
        ...
        expect((await reference).passwordProtection!.passwordType).toBe("pw");
        expect((await reference).passwordProtection!.salt).toStrictEqual(ownTemplate.passwordProtection!.salt);

        const peerTemplate = await recipient.relationshipTemplates.loadPeerRelationshipTemplateByTruncated((await reference).truncate(), "password");
        expect(peerTemplate).toBeDefined();
    ...
    test("should throw an error if loaded with a wrong or missing password", async function () {
        ...
        await expect(
            recipient.relationshipTemplates.loadPeerRelationshipTemplateByTruncated((await ownTemplate.toRelationshipTemplateReference()).truncate(), "wrongPassword")
        ).rejects.toThrow(
    ...
    test("should fetch multiple password-protected templates", async function () {
        ...
        await recipient.relationshipTemplates.loadPeerRelationshipTemplateByTruncated((await ownTemplate1.toRelationshipTemplateReference()).truncate(), "password");
        await recipient.relationshipTemplates.loadPeerRelationshipTemplateByTruncated((await ownTemplate2.toRelationshipTemplateReference()).truncate(), "1234");
    ...
    test("should send and receive a RelationshipTemplate using a truncated RelationshipTemplateReference", async function () {
        ...
        const receivedRelationshipTemplate = await recipient.relationshipTemplates.loadPeerRelationshipTemplateByTruncated(await sentRelationshipTemplate.truncate());
